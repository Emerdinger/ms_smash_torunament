...
import com.emerdinger.smashtorunament.infraestructure.endpoint.handler.TournamentHandler;
...
public class TournamentRouter {
    ...
    public RouterFunction<ServerResponse> createRouteTournament(TournamentHandler tournamentHandler) {
        return route(GET("/health"), request -> tournamentHandler.health())
                ...
                .andRoute(GET("/basic-tournament/findByFilters").and(accept(MediaType.APPLICATION_JSON)), tournamentHandler::findByFilters)
                ...
                .andRoute(PUT("/basic-tournament/update-status").and(accept(MediaType.APPLICATION_JSON)), tournamentHandler::updateStatus);
